...
class ComicPage:
    ...
    def optimizeForDisplay(self, reducerainbow, is_color):
        # Reduce rainbow artifacts for grayscale and color images by removing spectral frequencies that cause Moire interference with color filter array
        if reducerainbow:
