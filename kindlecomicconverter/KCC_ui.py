...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.mergeBox = QtWidgets.QCheckBox(self.optionWidget)
        self.mergeBox.setObjectName("mergeBox")
        self.gridLayout_2.addWidget(self.mergeBox, 1, 0, 1, 1)
        ...
        mainWindow.setTabOrder(self.mangaBox, self.mergeBox)
        mainWindow.setTabOrder(self.mergeBox, self.rotateBox)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.mergeBox.setToolTip(_translate("mainWindow", "<html><head/><body><p style='white-space:pre'><span style=\" font-weight:600; text-decoration: underline;\">Unchecked - No merged spreads<br/></span>The input file does not have any merged 2-page spreads.</p><p style='white-space:pre'><span style=\" font-weight:600; text-decoration: underline;\">Checked - Spreads are merged<br/></span>The input file contains merged 2 page spreads</p></body></html>"))
        self.mergeBox.setText(_translate("mainWindow", "Already merged?"))
