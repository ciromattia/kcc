...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.gridLayout_4.addWidget(self.directoryButton, 0, 5, 1, 1)

        self.enableDirectory = QCheckBox(self.buttonWidget)
        self.enableDirectory.setObjectName(u"enableDirectory")
        sizePolicy1 = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.enableDirectory.sizePolicy().hasHeightForWidth())
        self.enableDirectory.setSizePolicy(sizePolicy1)

        self.gridLayout_4.addWidget(self.enableDirectory, 0, 4, 1, 1)
