...
class Ui_KCC(object):
    ...
    def retranslateUi(self, KCC):
        ...
        self.NoDitheringBox.setToolTip(_translate("KCC", "<html><head/><body><p><span style=\" font-size:12pt;\">Create PNG files instead JPEG.<br/>Output files might be smaller.<br/></span><span style=\" font-size:12pt; font-weight:600;\">MOBI creation will be much slower.</span></p></body></html>", None))
